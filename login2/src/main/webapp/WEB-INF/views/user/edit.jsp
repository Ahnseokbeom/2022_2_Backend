				...
				<form:form method="post" modelAttribute="userEdit">
					...
					<div>
						<label>권한:</label> <label><form:checkbox path="roles"
								value="ROLE_ADMIN" /> ADMIN</label> <label><form:checkbox
								path="roles" value="ROLE_PROFESSOR" /> PROFESSOR</label> <label><form:checkbox
								path="roles" value="ROLE_STUDENT" /> STUDENT</label> <label><form:checkbox
								path="roles" value="ROLE_TA" /> TA</label>
					</div>
					<div>
						<label>활성화:</label>
