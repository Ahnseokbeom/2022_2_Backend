...
div.panel input[type=text]:focus {
...
div.panel label:not(:nth-child(1)) {
	margin-right: 30px;
}
		...
		<div class="panel">
			...
			<div class="panel-body">
				<form:form method="post" modelAttribute="userEdit">
					...
					<div>
						<label>권한:</label> <label><form:checkbox path="roles"
								value="ADMIN" /> ADMIN</label> <label><form:checkbox
								path="roles" value="PROFESSOR" /> PROFESSOR</label> <label><form:checkbox
								path="roles" value="STUDENT" /> STUDENT</label> <label><form:checkbox
								path="roles" value="TA" /> TA</label>
					</div>
					<div>
						<label>활성화:</label>
					...
					<button type="submit" class="btn2 red" name="cmd" value="delete"
						data-confirm-delete>
						<i class="fa fa-trash"></i> 삭제
					</button>
					<a href="list?${pagination.queryString}" class="btn2"><i
